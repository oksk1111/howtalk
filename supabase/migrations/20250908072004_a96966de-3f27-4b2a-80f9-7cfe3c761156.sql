...
CREATE TABLE public.messages (
  ...
  message_type TEXT NOT NULL DEFAULT 'text' CHECK (message_type IN ('text', 'ai_suggestion')),
  ai_persona TEXT,
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  updated_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()
);
...
CREATE POLICY "Users can view participants of their rooms" ON public.chat_participants FOR SELECT USING (
  EXISTS (
